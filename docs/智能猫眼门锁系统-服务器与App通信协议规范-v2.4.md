# 智能猫眼门锁系统 - App 通信协议规范 v2.4

> **协议升级提示**：本文档已从 v2.3 升级到 v2.4，主要变更：
>
...
| 版本 | 日期       | 变更说明                                                                                                                                                                                                                                  |
| ---- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v2.4 | 2026-01-30 | 统一所有错误码为 0-10 体系；简化 server_ack 错误码使用（0/3/8/9）；明确 server_ack 只用于接收确认，业务错误在业务响应中返回；删除"两套错误码"的说明；补充密码查询接口、媒体文件大小限制、音频解码错误处理、错误响应格式规范、实现注意事项 |
